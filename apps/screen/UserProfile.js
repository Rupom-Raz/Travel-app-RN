      ...
      <ScrollView>
         <View style={styles.container}>
            <View style={styles.avatarSection}>
               ...
               />
               <Title style={styles.usernName}>{logedInUser.username}</Title>
               <Caption style={styles.userLocation}>San Francisco, CA</Caption>
            </View>
            <View style={styles.userDetails}>
               <ContactField label="Username" value={logedInUser.username} />
